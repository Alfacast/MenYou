package com.alfacast.menyou.login.app;
...
public class AppConfig {
        ...
        //public static String URL_LOGIN = "http://10.0.3.2:80/youmenulogin/login.php";
        public static String URL_LOGIN = "http://www.cinesofia.it/alfacast/youmenulogin/login.php";
